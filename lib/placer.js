...
// The only module that moves windows. A maximized window ignores a resize, and
// a window moved and resized in one call can land on the old monitor's geometry,
// so the order is: unmaximize, move to monitor, move, then move+resize.
